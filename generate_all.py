...
o_script = f"{celeb_name}: That's all for this week's NFT Report on MOO19 News! Scan the Pasture Poll QR code to vote! {science_name}: Remember: Don't trust, verify! Read smart contracts before you mint! Goodnight!"
script_content += f"""
...
**[00:10 - 00:25] {celeb_name.upper()}:** "Blue-Chip Anchor: {selected_projects[0]['name']} at {selected_projects[0]['floor_price']}, and Top Volume Leader {selected_projects['name']} with {selected_projects['volume_24h']} volume!"
**[00:25 - 00:40] {science_name.upper()}:** "Breakout Gainer {selected_projects['name']}, plus Cross-Chain Titan {selected_projects['name']} on {selected_projects['chain']}!"
**[00:40 - 00:50] {celeb_name.upper()}:** "And our community Wildcard winner: {selected_projects['name']}!"
...
### 1. {selected_projects[0]['name']} — {selected_projects[0]['slot_title']}
**Category:** {selected_projects[0]['category']} | **Chain:** {selected_projects[0]['chain']} | **Source:** [{selected_projects[0]['name']}]({selected_projects[0]['official_url']})
**The Breakdown:** {selected_projects[0]['catalyst_lore']}
💡 **Tech Note:** {selected_projects[0]['science_tech']}

----------------------------------------

### 2. {selected_projects['name']} — {selected_projects['slot_title']}
**Category:** {selected_projects['category']} | **Chain:** {selected_projects['chain']} | **Source:** [{selected_projects[1]['name']}]({selected_projects['official_url']})
**The Breakdown:** {selected_projects['catalyst_lore']}
💡 **Tech Note:** {selected_projects['science_tech']}

----------------------------------------

### 3. {selected_projects['name']} — {selected_projects['slot_title']}
**Category:** {selected_projects['category']} | **Chain:** {selected_projects['chain']} | **Source:** [{selected_projects[2]['name']}]({selected_projects['official_url']})
**The Breakdown:** {selected_projects['catalyst_lore']}
💡 **Tech Note:** {selected_projects['science_tech']}

----------------------------------------

### 4. {selected_projects['name']} — {selected_projects['slot_title']}
**Category:** {selected_projects['category']} | **Chain:** {selected_projects['chain']} | **Source:** [{selected_projects[3]['name']}]({selected_projects['official_url']})
**The Breakdown:** {selected_projects['catalyst_lore']}
💡 **Tech Note:** {selected_projects['science_tech']}

----------------------------------------

### 5. {selected_projects['name']} — {selected_projects['slot_title']}
**Category:** {selected_projects['category']} | **Chain:** {selected_projects['chain']} | **Source:** [{selected_projects[4]['name']}]({selected_projects['official_url']})
**The Breakdown:** {selected_projects['catalyst_lore']}
💡 **Tech Note:** {selected_projects['science_tech']}
...
print(f"[✓] Dynamic 5-Slot Episode #{episode_index + 1} generated successfully!")
